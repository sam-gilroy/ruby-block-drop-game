...
class TetrisGame
  ...
  def iterate
    ...
    if k.key_down.left || k2.key_down.left
      ...
      puts @grid[@curr_piece_x][@curr_piece[0][@curr_piece[0].length-1]]
      puts @curr_piece[0]
      @curr_piece_x-=1 if (@curr_piece_x > 0) && (@grid[@curr_piece_x-1][@curr_piece_y]==0) && (@grid[@curr_piece_x][@curr_piece[0][@curr_piece[0].length-1]]==0)
    end
